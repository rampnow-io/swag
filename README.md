...
Or download a pre-compiled binary from the [release page](https://github.com/rampnow-io/swag/releases).
...
Find the example source code [here](https://github.com/rampnow-io/swag/tree/master/example/celler).
...
Find the result of formatting [here](https://github.com/rampnow-io/swag/tree/master/example/celler).
...
[#708](https://github.com/rampnow-io/swag/issues/708) The parser handles only struct comments starting with `@Description` attribute.
...
See [this file](https://github.com/rampnow-io/swag/blob/master/testdata/generics_nested/api/api.go) for more details
and other examples.
