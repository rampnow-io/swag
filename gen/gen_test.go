...
func TestGen_BuildDescriptionWithQuotes(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/rampnow-io/swag/testdata/quotes")
...
func TestGen_BuildDocCustomDelims(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/rampnow-io/swag/testdata/delims")
